...
1. Add one markdown file per skill area. One. Singular. Not `final_v3_REAL_THIS_ONE.md`.
2. Keep skills short and actionable. If it requires a philosophy degree, it’s too long.
3. Update after every meaningful change.  
   (Yes, that includes “small refactor, no impact.” It always has impact.)
4. For operational skills, use folder-based skills:  
   `<skill>/SKILL.md` + optional `agents/openai.yaml`  
